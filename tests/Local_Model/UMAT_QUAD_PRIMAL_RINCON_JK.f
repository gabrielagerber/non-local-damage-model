...
C     INTERFACE FOR ARRAY VALUED EXTERNAL FUNCTION VECDYAD
      ...
      END INTERFACE
C
C     COMMON BLOCK WITH NONLOCAL UEL
C
...
C 
        ...
        DHDK=0.0D0
        DYDS=DSY
        DYDK=-DRAD+VDYDK(VISCFL,ETA,MM,DTIME,DKAPPA1,DHDK,HI)
        DNPDS=(DDSY*HI-VECDYAD(DSY,DHDS))/HI**2
        DNPDK=0.0D0
C
...
C 
      DOUBLE PRECISION FUNCTION RADK(PYFL,EXPS,KMAX,RDY,RDY2,PDY,KAPPA)
      IMPLICIT NONE
...
C 
      DOUBLE PRECISION FUNCTION DRADK(PYFL,EXPS,KMAX,RDY,RDY2,PDY,KAPPA)
      IMPLICIT NONE
      DOUBLE PRECISION EXPS,RDY,KMAX,PDY,KAPPA,RDY2
      INTEGER PYFL
C
